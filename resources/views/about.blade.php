...
@section('content')
    ...
    <section class="breadcrumb-section set-bg spad" data-setbg="{{ asset('images/about-bread.jpg') }}">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <section class="testimonial-section set-bg spad" data-setbg="{{ asset('images/testimonial-bg.jpg') }}">
        <div class="container">
            <div class="row">
                    ...
                    <div class="testimonial-slider owl-carousel">
                        <div class="ts-item">
                            ...
                            <div class="author-pic">
                                <img src="{{ asset('images/author-pic.png') }}" alt="">
                            </div>
                        </div>
                        <div class="ts-item">
                            <div class="rating">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="trainer-item">
                        <div class="ti-pic">
                            <img src="{{ asset('images/trainer/trainer-4.jpg') }}" alt="">
                            <div class="ti-links">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-pinterest"></i></a>
                                <a href="#"><i class="fa fa-linkedin"></i></a>
